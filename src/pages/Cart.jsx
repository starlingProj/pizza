...
function Cart() {
  ...
  const onClearCart = () => {
    if (window.confirm('Ви справді бажаєте очистити корзину?')) {
      dispatch(clearCart());
    }
  }
  const onRemoveItem = (id) => {
    if (window.confirm("Ви справді бажаєте видалити піцу?")) {
          ...
          totalItem ? <div className="cart">
            ...
            <div className="cart__bottom">
              <div className="cart__bottom-details">
                <span> Всього піц: <b>{totalItem} шт.</b> </span>
                <span> Сумма замовлення: <b>{totalPrice} грн</b> </span>
              </div>
            ...
            <p>
              Ви ще не додили жодньої піци<br />
              Для того щоб замовити піцу, поверніться на головну сторінку
            </p>
